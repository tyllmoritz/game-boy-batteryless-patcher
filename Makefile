...
roms = $(roms_nortc) $(roms_batteryless-AAA-A9) $(roms_batteryless-AAA-A9_nortc) $(roms_batteryless-555-A9) $(roms_batteryless-555-A9_nortc)

ifeq (,$(shell command -v flips))
all: roms_nortc roms_batteryless-AAA-A9 roms_batteryless-555-A9 roms_batteryless-AAA-A9_nortc roms_batteryless-555-A9_nortc
else
all: patches_nortc patches_batteryless-AAA-A9 patches_batteryless-555-A9 patches_batteryless-AAA-A9_nortc patches_batteryless-555-A9_nortc
endif
...
patches_batteryless-AAA-A9: $(roms_batteryless-AAA-A9:.gbc=.bps)

roms_batteryless-AAA-A9: $(roms_batteryless-AAA-A9)

patches_batteryless-AAA-A9_nortc: $(roms_batteryless-AAA-A9_nortc:.gbc=.bps)

roms_batteryless-AAA-A9_nortc: $(roms_batteryless-AAA-A9_nortc)

patches_batteryless-555-A9: $(roms_batteryless-555-A9:.gbc=.bps)

roms_batteryless-555-A9: $(roms_batteryless-555-A9)

patches_batteryless-555-A9_nortc: $(roms_batteryless-555-A9_nortc:.gbc=.bps)

roms_batteryless-555-A9_nortc: $(roms_batteryless-555-A9_nortc)
